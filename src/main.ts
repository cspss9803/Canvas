...
canvasManager.uiObjects.push( new Box({x:200, y:50}, { width: 100, height: 100}, "rgba(255, 0, 0, 0.5)") )
...
canvasManager.uiObjects.push( new Line({x: 600, y: 400}, [{x: 700, y: 500}, {x: 800, y: 400}], '#000', 5) )
